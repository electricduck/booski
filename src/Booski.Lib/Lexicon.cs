...
namespace Booski.Lib.Lexicon {
    public class App {
        public class Bsky {
            public interface Actor {
                public Task<AtProtoApiResponse<GetPreferencesResponse>> GetPreferences();
                public Task<AtProtoApiResponse<GetProfileResponse>> GetProfile(string actor);
                ...
                public Task<AtProtoApiResponse<PutPreferencesResponse>> PutPreferences(List<Polymorph> preferences);
