...
public class Ja : II18n {
    public static Dictionary<Phrase, string> Strings = new Dictionary<Phrase, string>() {
        ...
        { Phrase.Console_Program_FirstRun, "Booskiを実行したことがないようですね！" },
        { Phrase.Console_Program_FirstRunEditConfig, "'[0]'のコンフィグを編集してください" },
        { Phrase.Console_Program_UpdateAvailable, "アップデートが利用可能です！" },
        { Phrase.Console_Program_UpdateAvailableDownload, "[1] から[0]をダウンロード" },
