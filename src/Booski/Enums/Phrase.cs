...
public enum Phrase
{
    ...
    Console_PostHelpers_Ignoring,
    Console_PostHelpers_IgnoringEmbedsButNotSupported,
    ...
    Console_Program_FirstRun,
    Console_Program_FirstRunEditConfig,
    Console_Program_UpdateAvailable,
    Console_Program_UpdateAvailableDownload,
