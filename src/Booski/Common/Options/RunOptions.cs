...
public class RunOptions : GlobalOptions
{
    ...
    [Option("sleep-time-fetch", Default = 1, HelpText = "Interval (in seconds) between fetching batches of your feed (limited to 100) from Bluesky.")]
    public int SleepTimeFetch { get; set; }
    [Option("sleep-time-sync", Default = 1, HelpText = "Interval (in seconds) between syncing individual posts to services.")]
