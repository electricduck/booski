...
```sh
cd ~/.local/bin
wget https://github.com/electricduck/booski/releases/download/v%2F0.x%2F0.5-rc5/booski-0.5-rc5-linux-x64.bin
chmod +x booski-0.5-rc5-linux-x64.bin
./booski-0.5-rc5-linux-x64.bin start --no-daemon
```
